...
if (args.length ==0)return reply(`Textnya mana kak? Contoh\n${prefix + command} Itschandra`)
bo = args.join(" ")
bf = await getBuffer(`https://api.lolhuman.xyz/api/hartacustom?apikey=itschandra&text=${bo}`)
helga.sendMessage(from, bf, image, { quoted: mek, caption: 'Logo By Itschandra Official' })
break
case 'tweettrump':
if (args.length ==0)return reply(`Textnya mana kak? Contoh\n${prefix + command} Itschandra`)
bo = args.join(" ")
bf = await getBuffer(`https://api.lolhuman.xyz/api/tweettrump?apikey=itschandra&text=${bo}`)
helga.sendMessage(from, bf, image, { quoted: mek, caption: 'Logo By Itschandra Official' })
break
case 'amongus':
if (args.length ==0)return reply(`Textnya mana kak? Contoh\n${prefix + command} Itschandra`)
...
helga.sendMessage(from, among, sticker)
break
...
case 'togif':
        ...
        helga.sendMessage(m.chat, { url }, 'videoMessage', { caption: `Sukses~`, mimetype: 'video/gif', quoted: m })
        break
